<?php
	...
	echo $_s->build_css(
		is_admin() ? 'body' : 'body, button, input, select, textarea', // we need to explicitly define that for form fields, too, to avoid that Chrome will override it with user agent style sheets.
		array_merge(
